...
func registerOptionalAdminRoutes(mux, authMux *http.ServeMux, cfg *config.Config, database *db.DB, floorplanHandler *handlers.FloorplanHandler, projectsHandler *handlers.ProjectsHandler) {
	...
	if !cfg.DisableProjects {
		...
		mux.Handle("/admin/projects-report", middleware.Auth(database, middleware.RequireRoleOrDomainManager(database, models.RoleProjectsManager, models.RoleProjectsViewer, models.RoleTeamLeader)(projReportMux)))
		mux.Handle("/api/projects-report", middleware.Auth(database, middleware.RequireRoleOrDomainManager(database, models.RoleProjectsManager, models.RoleProjectsViewer, models.RoleTeamLeader)(projReportMux)))
