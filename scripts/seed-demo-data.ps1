...
$users = @(
    @{ email = "alice.martin@corp.local"; name = "Alice Martin"; password = "demo1234"; role = "team_manager"; site = "Paris - WW HQ" },
    @{ email = "bob.dupont@corp.local"; name = "Bob Dupont"; password = "demo1234"; role = "basic"; site = "Paris - WW HQ" },
    @{ email = "claire.leroy@corp.local"; name = "Claire Leroy"; password = "demo1234"; role = "basic"; site = "Paris - WW HQ" },
    @{ email = "david.simon@corp.local"; name = "David Simon"; password = "demo1234"; role = "basic"; site = "Strasbourg - Logistic site" },
    @{ email = "emma.garcia@corp.local"; name = "Emma Garcia"; password = "demo1234"; role = "activity_viewer"; site = "Paris - WW HQ" },
    @{ email = "felix.nguyen@corp.local"; name = "Felix Nguyen"; password = "demo1234"; role = "basic"; site = "Tunis - Regional hub" },
    @{ email = "grace.chen@corp.local"; name = "Grace Chen"; password = "demo1234"; role = "basic"; site = "Paris - WW HQ" },
    @{ email = "hugo.moreau@corp.local"; name = "Hugo Moreau"; password = "demo1234"; role = "basic"; site = "Strasbourg - Logistic site" },
    @{ email = "iris.blanc@corp.local"; name = "Iris Blanc"; password = "demo1234"; role = "basic"; site = "Tunis - Regional hub" },
    @{ email = "julien.roux@corp.local"; name = "Julien Roux"; password = "demo1234"; role = "basic"; site = "Lyon - Coworking site" }
)
$userIDs = @{}
$userIDs["admin"] = 1
...
$siteItems = @(
    @{ name = "Paris - WW HQ"; country_code = "FR"; not_corporate_site = $false; seats = 50 },
    @{ name = "Strasbourg - Logistic site"; country_code = "FR"; not_corporate_site = $false; seats = 20 },
    @{ name = "Tunis - Regional hub"; country_code = "MA"; not_corporate_site = $false; seats = 15 },
    @{ name = "Lyon - Coworking site"; country_code = "FR"; not_corporate_site = $true; seats = 10 }
)
$siteIDs = @{}
...
$parisSiteId = if ($siteIDs["Paris - WW HQ"]) { $siteIDs["Paris - WW HQ"] } else { 0 }
...
if ($adminId -and $parisSiteId) {
    ...
    Write-Host "  Administrator (id=$adminId) -> site 'Paris - WW HQ' (id=$parisSiteId)"
}
...
$newsItems = @(
    @{
        ...
        content    = "This demo showcases all the features of myPresence. Check the [documentation](https://github.com/matoy/mypresence) to learn more."
