...
var de = map[string]string{
	...
	"projects.manual.no_activities_day":        "Für diesen Tag wurde keine Aktivität erfasst.",
...
var es = map[string]string{
	...
	"projects.manual.no_activities_day":        "No hay actividad declarada para este día.",
